...
import curosel1 from "../Assets/curosel_1.jpg"
import curosel2 from "../Assets/curosel_2.jpg"
import curosel3 from "../Assets/curosel_3.jpg"
        ...
        <div>
                ...
                <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active" data-bs-interval="3000">
                            <img src={curosel1} class="d-block w-100" width="100%" alt="..."/>
                        </div>
                        <div class="carousel-item" data-bs-interval="3000">
                            <img src={curosel2} class="d-block w-100" width="100%" alt="..."/>
                        </div>
                        <div class="carousel-item" data-bs-interval="3000">
                            <img src={curosel3} class="d-block w-100" width="100%" alt="..."/>
                        </div>
                    </div>
            ...
            <div className='container mt-5'>
                <marquee behavior="alternate" direction="right" scrollamount="10" >
                    <h3><strong>Hurry Up Offers is Going on!!!!</strong></h3>
                </marquee>
            </div>
